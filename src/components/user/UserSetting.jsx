...
function UserSetting() {
  const [formData, setFormData] = useState({
    firstName: "Bemor",
    lastName: "Ismi",
    email: "bemor@example.uz",
    phone: "+998901234567",
    medicalHistory: "Allergiya: Penitsillin\nSurunkali kasallik: Yo'q",
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2 md:col-span-2">
                  <label className="text-sm font-medium text-gray-700 flex items-center">
                    <Heart className="h-4 w-4 mr-2 text-[#3d99f5]" />
                    Tibbiy tarix
                  </label>
                  <textarea
                    name="medicalHistory"
                    ...
                    onChange={handleInputChange}
                    rows={3}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3d99f5] focus:border-transparent transition-all resize-none"
                    placeholder="Allergiyalar, surunkali kasalliklar va boshqa ma'lumotlarni kiriting..."
                  />
                </div>
